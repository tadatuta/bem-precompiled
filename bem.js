...
/* begin: ../../libs/bem-bl/blocks-common/i-bem/__html/i-bem__html.bemhtml */
...
match(this._mode === '')(
    ...
    match(this.ctx && this.ctx.hasOwnProperty('_res'))(function() {
        applyCtx(this.ctx._res)
    })
...
/* end: ../../libs/bem-bl/blocks-common/i-bem/__html/i-bem__html.bemhtml */

extendTemplates(apply, applyNext, applyCtx, block, elem, tag, attrs, cls, js, jsAttr, bem, mix, content);
...
})(this);/* ../../libs/bem-bl/blocks-common/i-jquery/__inherit/i-jquery__inherit.js begin */
/**
 * Inheritance plugin
 *
